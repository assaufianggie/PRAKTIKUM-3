...
<html lang="en">
  ...
  <body>
    <div class="container-fluid" style="max-width:1366px;">    
      <div class="row">
        <div class="col-6">
          <form class="form-horizontal p-5 shadow h-100" style="background-color:#F7DCB4;" method="GET" action="halamanBMI.php">
            <div class="text-center">
              <h3 class="mb-5  text-mg" style="color:#C35817;">FORM ISIAN INDEXS MASSA TUBUH (BMI)</h3>
            </div>
            <!------------>
              <div class="form-group row">
                <label for="namalengkap" class="col-sm-4 col-form-label"  style="color:#C35817;"><b>Nama Lengkap</b></label>
                <div class="col-sm-8">
                  <input type="text" class="form-control"  style="color:#C35817;" name="nama__lengkap" required>
                </div>
              </div>
              <br>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <div class="input-group mb-2 mr-sm-2">
                    <input type="text" class="form-control"  style="color:#C35817;" name="berat__" required>
            ...
            <!------------>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <div class="input-group mb-2 mr-sm-2">
                    <input type="text" class="form-control"  style="color:#C35817;" name="tinggi__" required>
                    <div class="input-group-prepend">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <div class="input-group mb-2 mr-sm-2">
                    <input type="text" class="form-control"  style="color:#C35817;" name="umur__" required>
                    <div class="input-group-prepend">
        ...
        <div class="col-6">
          <div class="shadow p-5 h-100" style="background-color:#B0DFE5;">
            
            <h3 class="text-center" style="color:#0F52BA;" >HASIL EVALUASI BMI</h3>
            <h6 class="mb-3 text-center" style="color:#008ECC;">OUTPUT FORM</h6>
          <?php
          class bmiPasien {
            public $nama,
                   $berat,
